...
Drop the six sound files referenced by `lib/sounds/index.ts` into this folder before public launch. v1 uses CC0 sources from Pixabay Sound Effects (legally free, attribution not required — see spec section 14).
